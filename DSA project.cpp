//Advande AVL Tree Programme in C++
//Project ideas in C++
//github.com/tayyaburrehmann


//What it does? (show you inorder, preorder, postorder and print AVL tree for your easiness...
...
int main()
{
	...
	while (1)
	{
		...
		case 2:
			...
			cin >> item;
			if (root == NULL) {
				cout << "You didn't enter any value. Kindly Enter a value " << endl;
				break;
			}
			else {
